...
if ($query) {
	...
	$tableData = $tableWithHeaderModel->openTableHeader($model, $tableAttr, $tableExclude, true)
		...
		->appendQueryString($tableQueryString)
		->generateTableBody(null, true, 0, null, ' order by ID desc ', $where)
	// ->pagedTable(true,20)
		->generate();
}
...
?>
    ...
    <div class="modal fade" tabindex="-1" id="myModal" role="dialog">
      <div class="modal-dialog modal-dialog-top" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title"><?php echo removeUnderscore($model == 'giveaway_setting' ? 'Crossover Setting' : $model); ?> Record Form</h5>
                  <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                      <em class="icon ni ni-cross"></em>
                  </a>
              </div>
    ...
    <div id="modal-edit" class="modal fade animated" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><?php echo removeUnderscore($model == 'giveaway_setting' ? 'Crossover Setting' : $model); ?> Update</h5>
                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
