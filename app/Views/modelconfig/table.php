...
$tableAttr = ($configData && array_key_exists('table_attr', $configData)) ? $configData['table_attr'] : array('class' => 'datatable-init nowrap nk-tb-list is-separate table table-bordered', "data-auto-responsive" => 'false', 'id' => 'datatable-external-buttons');
