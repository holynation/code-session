...
* And it represent the model of the roles_permission table
*/
...
* @var array
*/
public static $typeArray = ['role_id' => 'text','permission' => 'varchar'];
...
* @var array
*/
public static $labelArray = ['id' => '','role_id' => '','permission' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/roles_permission', 'edit' => 'edit/roles_permission'];
