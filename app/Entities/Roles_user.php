...
* And it represent the model of the roles_user table
*/
...
* @var array
*/
public static $typeArray = ['role_id' => 'int','user_id' => 'int'];
...
* @var array
*/
public static $labelArray = ['id' => '','role_id' => '','user_id' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/roles_user', 'edit' => 'edit/roles_user'];
