...
* And it represent the model of the roles table
*/
...
* @var array|string
*/
public static $displayField = 'slug';
...
* @var array
*/
public static $typeArray = ['name' => 'varchar','status' => 'tinyint'];
...
* @var array
*/
public static $labelArray = ['id' => '','name' => '','status' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/roles', 'edit' => 'edit/roles'];
...
protected function getOffices(){
	...
	$resultObject = new \App\Entities\Offices($result[0]);
	return $resultObject;
}
...
protected function getVoters(){
	...
	$resultObject = new \App\Entities\Voters($result[0]);
	return $resultObject;
}
